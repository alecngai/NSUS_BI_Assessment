...
The [ticket section](https://github.com/alecngai/NSUS_BI_Assessment/blob/main/Resources/Tickets.png) is not sorted and could be compressed and simplified. When you finish a game and say play again, it does not specify if you are using tickets, *T$*, *C$* or USD. 
...
![ERD](https://github.com/alecngai/NSUS_BI_Assessment/blob/main/Resources/ERD.png)
...
![Game_History_EX](https://github.com/alecngai/NSUS_BI_Assessment/blob/main/Resources/Fake_Game_History.png)
...
Primary Key and Foreign key are listed as [PK and FK](#players-as-p), and the connections are shown on the [ERD diagram above](https://github.com/alecngai/NSUS_BI_Assessment/blob/main/Resources/ERD.png). 
